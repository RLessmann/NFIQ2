...
if( NOT ANDROID AND NOT "${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  file(GLOB ASTYLE_NFIQ2_ALGORITHM "${ROOT_PATH}/NFIQ2/NFIQ2Api/*.cpp" "${ROOT_PATH}/NFIQ2/NFIQ2Api/*.h" ) 
  file(GLOB ASTYLE_NFIQ2_API "${ROOT_PATH}/NFIQ2/NFIQ2Api/*.cpp" "${ROOT_PATH}/NFIQ2/NFIQ2Api/*.h" ) 
  file(GLOB ASTYLE_NFIQ2_TRAINING "${ROOT_PATH}/NFIQ2/NFIQ2Api/*.cpp" "${ROOT_PATH}/NFIQ2/NFIQ2Api/*.h" ) 
